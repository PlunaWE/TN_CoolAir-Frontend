...
export default function PaymentFailurePage() {
  ...
  trackEvent("payment", "failure_page_view");
  return (
    <BrandShell>
      <section style={{ padding: "48px 0 70px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ background: "#fff", borderRadius: 24, padding: 34, textAlign: "center", boxShadow: "0 10px 30px rgba(0,0,0,0.04)" }}>
            ...
            <h1 style={{ fontSize: 44, margin: "12px 0", color: "#06066d" }}>Zahlung fehlgeschlagen</h1>
            <p style={{ fontSize: 20, color: "#6b7280" }}>Die Zahlung konnte nicht bestätigt werden. Bitte versuchen Sie es erneut.</p>
